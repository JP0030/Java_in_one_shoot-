...
public class Java_Variables {
    ...
    public static void main(String[] args) {
        ...
        // and the ' = ' assignment operator is assign the valu to the vavriable acording to it's type
        ...
        */  // this is the another way to define the variable
        ...
        // as par above we also overwrite the value to. by variable 'number' with value of 21 to overwrite 30 
        int number = 21;
        number = 30;
        System.out.println(" overwrited value of int number :- " + number);

        // there are another method with you can prevent the value from overwrit... as 'final' key word
        final int numBer = 30;
        System.out.println(" you can note overwrited value of int numBer :- " + numBer);

        // now Create a variable called myName of type String and assign it the value "Nish":
        String myName = "Nish";
